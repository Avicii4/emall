...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(Integer userId, Long orderNo, String path) {
        ...
        // (必填) 订单标题，粗略描述用户的支付目的。
        String subject = new StringBuilder().append("EMall扫码支付，订单号：").append(outTradeNo).toString();
        ...
        // (必填) 商户门店编号，通过门店号和商家后台可以配置精准到门店的折扣信息，详询支付宝技术支持，如连锁店可用
    ...
    public void closeOrder(int hour) {
        ...
        List<Order> orderList = orderMapper.selectOrderStatusByCreateTime(Const.OrderStatusEnum.NO_PAY.getCode(), DateTimeUtil.date2Str(closeDateTime));
        for (Order order : orderList) {
